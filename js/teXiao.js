...
jQuery(document).ready(function($){
    addTips = function(e){
        var a= new Array("这个","特效","是我","网上","copy","下来的","需要","JQuery","支持");
        var color=new Array("red","orange","yellow","green","blue","cyan","purple");
        var color_idx=parseInt(Math.random()*(color.length-0)+0);
